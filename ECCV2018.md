...
| ID  | Novelty | Code | 
| :---:  | :---:  | :---:  | 
| CornerNet Detecting Objects as Paired Keypoints | we detect an object bounding box as a pair of keypoints(the
top-left and bottom-right corner | [Code](we detect an object bounding box as a pair of keypoints, the
